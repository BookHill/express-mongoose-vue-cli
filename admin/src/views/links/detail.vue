        ...
        <div class="wrapper">
            <form id="form" @submit.prevent="validateBeforeSubmit">
                ...
                <table class="_Table_Form_">
                    ...
                    <tr>
                        <td class="_key_">网址：</td>
                        <td class="_value_">
                            <input :class="{'input': true, 'is-danger': errors.has('url')}" 
                                v-validate="'required|url'" 
                                type="text" 
                                name="url" 
                                v-model="formData.url"/>
                            <label class="is-danger" v-show="errors.has('url')">{{ errors.first('url') }}</label>
                        </td>
                    </tr>
                </table>
