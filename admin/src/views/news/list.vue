    ...
    <div class="wrapperVue">
        ...
        <div class="wrapper">
            ...
            <div class="clearfix wrapper-nav">
                <ul class="left">
                    <li>
                        <router-link class="navlink" :to="'/home/news/add'">
                ...
                <ul class="right">
                    <li>
                        <select class="select" v-model="selected">
                            <option value="allType" selected="selected">全部</option>
...
<script>
    export default {
        ...
        methods: {
            ...
            listPost(type, page) {
                this.$http.post('/api/users/news/find', {
                    params: { type, page }
                }).then( (response) => {
                    let res = response.data;
                    if ( res.session==true && res.status==1 ) {
            ...
            deletePost(id) {
                ...
                this.$popup.prompt( () => {                 // callback
                    this.$http.post('/api/users/news/delete', {
                        params: { id }
                    }).then( (response) => {
                        let res = response.data;
                        if ( res.session==true && res.status==1 ) {
