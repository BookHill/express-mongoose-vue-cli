    ...
    <div class="wrapperVue">
        ...
        <div class="wrapper">
            ...
            <div class="clearfix wrapper-nav">
                <ul class="left">
                    <li>
                        <router-link class="navlink" :to="'/home/lease/type/area/add'">
                ...
                <tr v-for="(table, index) in tables">
                    ...
                    <td>
                        <router-link class="handleEdit" 
                            :to="'/home/lease/type/area/'+(index+(page.current-1)*10)">编辑
                        </router-link>
...
<script>
    export default {
        ...
        methods: {
            listPost(page) {
                this.$http.post('/api/users/leaseType/area/find', {
                    params: { page }
                }).then( (response) => {
            ...
            deletePost(bottom, top) {
                ...
                this.$popup.prompt( () => {                 // callback
                    this.$http.post('/api/users/leaseType/area/delete', {
                        params: { bottom, top }
                    }).then( (response) => {
                        let res = response.data;
                        if ( res.session==true && res.status==1 ) {
